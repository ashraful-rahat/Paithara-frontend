...
const defaultSlides: CarouselSlide[] = [
  {
    id: 1,
    title: 'পাইথারা স্কুলে স্বাগতম',
    subtitle: 'জ্ঞানের আলোয় আলোকিত হোন',
    description: 'আমাদের আধুনিক শিক্ষা ব্যবস্থা এবং অভিজ্ঞ শিক্ষকমণ্ডলীর মাধ্যমে আপনার সন্তানের ভবিষ্যৎ গড়ে তুলুন।',
  ...
  },
  {
    ...
    description: 'আধুনিক প্রযুক্তি এবং উদ্ভাবনী শিক্ষা পদ্ধতির মাধ্যমে শিক্ষার্থীদের সর্বোচ্চ সম্ভাবনা বিকাশে সহায়তা করি।',
  ...
  },
  {
    ...
    description: 'প্রতিটি শিক্ষার্থীর ব্যক্তিগত বিকাশ এবং একাডেমিক সাফল্য নিশ্চিত করার জন্য আমরা প্রতিশ্রুতিবদ্ধ।',
    ...
    <div className="relative w-full h-[500px] md:h-[600px] overflow-hidden">
      ...
      {showControls && (
        <>
          ...
          >
            {isAutoPlaying ? <Pause size={16} className="md:w-5 md:h-5" /> : <Play size={16} className="md:w-5 md:h-5" />}
          </motion.button>
        </>
      )}
