...
const AboutPage = () => {
  ...
  const facilities = [
    ...
    {
      name: "নিরাপদ পানীয় জলের ব্যবস্থা",
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            এই প্রতিষ্ঠানটি ১৯৮৫ সালে যাত্রা শুরু করে এখন পর্যন্ত কোন রকম চলছে।
            শুরু থেকে বিদ্যালয়টির সাথে জড়িত ছিলেন স্বনামধন্য ব্যক্তি জনাব
            মফিজুর রহমান চৌধুরী। তাহার সাথে ছিলেন জনাব আব্দুস সালাম ভূঁইয়া,
            জনাব শফিকুর রহমান ভূঁইয়া জনাব এয়ার আহমেদ ভূঁইয়া, আবুল কালাম
            ভূইয়া, জনাব কাজী মফিজুর রহমান,, জনাব শফিউদ্দিন ভূঁইয়া, জনাব আফজলের
            রহমান চৌধুরী, জনাব আমিনুল হক পাটোয়ারী, জনাব খায়েজ আহমদ চৌধুরী সহ
            আরো অনেক গণ্যমান্য ব্যক্তি। এর বাহিরে আরো অনেক ব্যক্তি জড়িত ছিলেন ।
            তাদের সম্পর্কে আমার খুব বেশি ধারণা নেই।এ সম্পর্কে আমাদের প্রতিষ্ঠাতা
            প্রধান শিক্ষক জনাব একে আজাদ চৌধুরী ভালোভাবে জানেন। উনার সাথে একটু
            যোগাযোগ করলে ভালো হবে 
          </motion.p>
        </div>
      </motion.section>
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
              ...
              <p>
                ...
                প্রতিভাকে বিকশিত করা এবং তাদের নৈতিক, আধ্যাত্মিক ও বুদ্ধিবৃত্তিক
                উন্নতি সাধন করা।
              </p>
            </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`inline-flex p-4 bg-gradient-to-r ${feature.color} rounded-2xl text-white mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
                  {feature.icon}
                </div>
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                ...
                নৈতিকতাসম্পন্ন এবং দেশপ্রেমিক নাগরিক হিসেবে গড়ে তোলা। আমরা চাই
                প্রতিটি শিক্ষার্থী জ্ঞান, বিজ্ঞান ও প্রযুক্তিতে দক্ষ হয়ে সমাজের
                কল্যাণে নিজেদের নিয়োজিত করুক।
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                আমাদের স্বপ্ন হলো পৈথারা উচ্চ বিদ্যালয়কে এই অঞ্চলের সেরা শিক্ষা
                প্রতিষ্ঠান হিসেবে প্রতিষ্ঠিত করা। আমরা চাই আমাদের প্রাক্তন
                শিক্ষার্থীরা দেশ ও বিদেশে নিজেদের মেধা ও যোগ্যতার পরিচয় দিক।
              </p>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((item, index) => (
              ...
              >
                <div
                  className={`inline-flex p-4 bg-gradient-to-r ${item.color} rounded-2xl text-white mb-6`}
                >
                  {item.icon}
                </div>
